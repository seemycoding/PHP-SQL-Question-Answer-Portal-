...
<aside>
	...
	<a href="homepost.php?value=<?php echo $check; ?>"><h4>Your Post</h4></a>
...
echo "<button>Show Comments</button><br>";
echo "<div class = container>";
	echo "<div class = Comment id= show>";
			...
			foreach ($post as $posts) 
					{
						...
						if ($id==$posts['id']) 
							{
							echo "<h5>". $posts['Author']."<label class= date>".$posts['Date']."</label>"."<br>".$posts['Comment']."</h5>";
	...
	echo "<form action = home.php method=POST>
		...
		<input name=data id=any value=$id type=hidden> 
		<input name=author id=data value=$check type=hidden>
